...
trap_init(void)
{
	...
	SETGATE(idt[T_BRKPT], 0, GD_KT, Entry_Breakpoint, 3);	//breakpoint needs no kernel mode privilege	
	...
	SETGATE(idt[T_SIMDERR], 0, GD_KT, Entry_Simd_Floating_Point_Error, 0);
	// Per-CPU setup 
	trap_init_percpu();
}
